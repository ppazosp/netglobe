class Marker {
  ...
  createLabel() {
    ...
    const scale = 0.15;
    this.label.scale.set(textWidth * scale, textHeight * scale, 1);

    const offsetY = (textHeight * scale) / 2; 
    this.label.position.set(0, offsetY + 2.5, 0); 
  ...
  createText() {
    ...
    canvas.setWidth(textWidth + 20);
    canvas.setHeight(textHeight + 10);
